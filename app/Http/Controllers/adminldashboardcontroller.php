...
class adminldashboardcontroller extends Controller
{
    ...
    {
        $datasiswa = DB::select("SELECT COUNT(*) as total FROM siswa");
        $datapresverif = DB::select("SELECT COUNT(*) as total FROM prestasi WHERE isverif = 0");
        $dataaktifverif = DB::select("SELECT COUNT(*) as total FROM keaktifan WHERE isverif = 0");
