...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <a href="index3.html" class="brand-link">
                <img src="/adminlte/dist/img/sippreslogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">SIPPreS</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="/images/{{auth()->user()->tampilnmuser(auth()->user()->username)->foto}}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
